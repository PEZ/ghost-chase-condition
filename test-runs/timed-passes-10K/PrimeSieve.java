...
public class PrimeSieve {
	...
	public void printResults(int passes, long time) {
		System.out.printf("Time: %d, Passes: %d, count: %d, Valid: %s%n", time, passes, sieve.cardinality(),
	...
	public static void main(String[] args) {
		...
		if (sieve != null) {
			sieve.printResults(passes, System.currentTimeMillis() - start);
		}
	}
